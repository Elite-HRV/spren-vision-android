...
class BodyPositionErrorBodyCompFragment : Fragment() {
    ...
    private fun setActionListeners() {
        binding.closeImage.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_BodyPositionErrorBodyCompFragment_to_GreetingBodyCompFragment)
        }
        binding.tryNowButton.setOnClickListener {
            findNavController().navigate(R.id.action_BodyPositionErrorBodyCompFragment_to_ScanningBodyCompFragment)
        }
