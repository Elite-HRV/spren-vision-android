...
open class SprenCapture(
    ...
    // width and height must be a 4:3 resolution
    ...
    companion object {
        ...
        private const val SECONDARY_WIDTH = 160
        private const val SECONDARY_HEIGHT = 120
    ...
    private inner class RGBAnalyzer :
    ...
    private fun buildImageAnalysis(highestAvailableFPS: Range<Int>): ImageAnalysis {
        ...
        return builder
            .build()
            .also {
                it.setAnalyzer(cameraExecutor!!, RGBAnalyzer())
            }
    }
    ...
    private fun dropResolution(): Boolean {
        return if (width == DEFAULT_WIDTH && height == DEFAULT_HEIGHT) {
